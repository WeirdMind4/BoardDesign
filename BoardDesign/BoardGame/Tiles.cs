        ...
        public void Panel_Click(object sender, EventArgs e)
        {
            ...
            if (me.Button == MouseButtons.Right)//if right click
            {
                ...
                if (allSelectedUnits[0] != null)//and unit was previously selected
                {
                    ...
                    {
                        MessageBox.Show("Tile already on this panel");
                        //this is where we could cave added code for making the panels smaller and exist side by side when on the same tile
                    }
                    //move the unit
                    else
                    {
